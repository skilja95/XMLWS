...
// Generated on: 2017.06.19 at 04:52:18 PM CEST 
//
...
public class Presek {
    ...
    @XmlElement(namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
    protected Presek.Zaglavlje zaglavlje;
    @XmlElement(namespace = "http://www.ftn.uns.ac.rs/presek")
    ...
    public static class Stavka {
        ...
        @XmlElement(name = "svrha_placanja", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected String svrhaPlacanja;
        @XmlElement(namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected String poverilac;
        @XmlElement(name = "datum_naloga", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumNaloga;
        @XmlElement(name = "datum_valute", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumValute;
        @XmlElement(name = "racun_duznika", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected TRacun racunDuznika;
        @XmlElement(name = "racun_poverioca", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
    ...
    public static class Zaglavlje {
        ...
        @XmlElement(name = "broj_racuna", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected String brojRacuna;
        @XmlElement(name = "datum_naloga", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumNaloga;
        @XmlElement(name = "broj_preseka", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected BigInteger brojPreseka;
        @XmlElement(name = "prethodno_stanje", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected BigDecimal prethodnoStanje;
        @XmlElement(name = "broj_promena_u_korist", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected BigInteger brojPromenaUKorist;
        @XmlElement(name = "broj_promena_na_teret", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        @XmlSchemaType(name = "positiveInteger")
        protected BigInteger brojPromenaNaTeret;
        @XmlElement(name = "ukupno_u_korist", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected BigDecimal ukupnoUKorist;
        @XmlElement(name = "ukupno_na_teret", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
        protected BigDecimal ukupnoNaTeret;
        @XmlElement(name = "novo_stanje", namespace = "http://www.ftn.uns.ac.rs/presek", required = true)
